...
This command **requires** the project directory as an argument via `/Users/toshonjennings/opal`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/toshonjennings/opal/.autoforge/prompts/app_spec.txt` and `/Users/toshonjennings/opal/.autoforge/prompts/initializer_prompt.md`

If `/Users/toshonjennings/opal` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/toshonjennings/opal/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/toshonjennings/opal/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/Users/toshonjennings/opal/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/Users/toshonjennings/opal/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/toshonjennings/opal/.autoforge/prompts/`!
>
> **Files created:**
> - `/Users/toshonjennings/opal/.autoforge/prompts/app_spec.txt`
> - `/Users/toshonjennings/opal/.autoforge/prompts/initializer_prompt.md`
>
