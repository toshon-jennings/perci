...
export const PERCI_SURFACE_STATIONS = [
    ...
    { id: 'dotenvx-gui', targetId: DOTENVX_WINDOW_ID, label: 'Dotenvx', kind: 'system', districtId: 'local-systems-depot', x: 890, y: 690, description: 'Local environment-file editor and dotenvx command runner.' },
