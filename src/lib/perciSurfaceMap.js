...
export const PERCI_SURFACE_STATIONS = [
    ...
    { id: 'dotenvx-gui', targetId: DOTENVX_WINDOW_ID, label: 'Dotenvx GUI', kind: 'system', districtId: 'local-systems-depot', x: 890, y: 690, description: 'Local environment-file editor and dotenvx command runner.' },
...
export const PERCI_SURFACE_ROUTES = [
    ...
    { id: 'local-runtime', type: 'runtime', label: 'Runtime Connector', stationIds: ['markitdown', 'localhost', 'git-shells', 'lighthouse', 'openclaw', 'studioos', 'open-notebook', 'klipit', 'pxpipe', 'keysafe', 'dotenvx-gui', 'apfel', 'docker', 'db-inspector', 'github-overview'] },
