...
const PERSISTED_KEYS = [
    ...
    'perci_diff_reviews',
    'perci_budget_state',
    'perci_memory_backend',
    'perci_supermemory_enabled',
    'perci_supermemory_api_key',
    'perci_supermemory_model',
    'perci_supermemory_openrouter_key',
    'perci_supermemory_provider',
    'perci_supermemory_model_base_url',
    'perci_supermemory_data_dir',
    'perci_supermemory_container_tag',
    'perci_supermemory_binary_path',
    'perci_supermemory_port',
    ...
    'perci_localhost_bookmarks',
    'perci_localhost_history',
    'perci_localhost_search',
    'perci_localhost_pinned_tabs',
    'perci_klipit_last_url',
    'perci_klipit_home',
    'perci_klipit_allow_http',
    'perci_klipit_bookmarks',
    'perci_klipit_history',
    'perci_klipit_search',
    'perci_klipit_pinned_tabs',
    'perci_dock_autohide',
    'perci_concerns:v1',
